...
HD_PWD='/home/hildeb47/proj/ECE1373_ghostSynth/MITXZ7100/mitx_petalinux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mitx_petalinux_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mitx_petalinux_wrapper.tcl
