...
HD_PWD='/root/repo/shs/ECE1373_GhostSynth/MITXZ7100_2017/mitx_petalinux.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mitx_petalinux_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mitx_petalinux_wrapper.tcl -notrace
